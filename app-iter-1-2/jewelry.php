  ...
  <body>
    ...
    <!-- List of main pages -->
      <nav>
        ...
        <h2> All Active Jewelry Auctions </h2>
        ...
        <?php 
            ...
            foreach ($auctions as $currAuc) :
               if($currAuc['ITEM_CATEGORY'] == $jewelry): 
                $isPresent = true;
        ?>
                  <div class="item">
                    <img src="showPhoto.php?auctionId=<?=htmlspecialchars($currAuc['ITEM_PHOTO'])?>" 
                         alt="<?=htmlspecialchars($currAuc['ITEM_CAPTION'])?>"/>
        ...
        <?php 
            ...
            if($isPresent == false):
        ?>      
               <h3>No pending jewelry auctions</h3>
        <?php 
              endif;       
        ?> 
