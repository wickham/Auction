...
<!-- List of main pages -->
  <nav>
    ...
    <?php 
        ...
        if($isPresent == false){
           echo "<ul><li>No pending clothing auctions</li></ul>";
        }
    ?> 
    ...
    <?php 
        ...
        $isPresent = false;
        foreach ($auctions as $currAuc) :
           if($currAuc['ITEM_CATEGORY'] == $furniture): 
            $isPresent = true;
    ?>
              <div class="item">
                <img src="showPhoto.php?auctionId=<?=htmlspecialchars($currAuc['ITEM_PHOTO'])?>" alt="<?=htmlspecialchars($currAuc['ITEM_CAPTION'])?>"/>
    ...
    <?php 
        ...
        if($isPresent == false){
           echo "<ul><li>No pending furniture auctions</li></ul>";
        }
    ?>  
    ...
    <?php 
        ...
        if($isPresent == false){
           echo "<ul><li>No pending jewelry auctions</li></ul>";
        }
    ?> 
