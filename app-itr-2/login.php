...
<form name="user" action="signed.php" method="post">
<span class="search">
Username:
...
<div class="red">
<h1>Login</h1>
<form class="login" name="user" action="signed.php" method="post">
Username:
...
<div class="red">
<h1>Sign-up</h1>
<form class="register" name="register" action="signed.php" method="post">
First Name:
