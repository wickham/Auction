...
if ($getValue['HIGH_BID'] >= $amount) 
{
	...
	header('Location: item.php?id=' . $auction);
}
else 
{
	// insert new bid
	...
	{
		header('Location: failure.php?message=' . htmlspecialchars("Your bid was unsuccessful. Try again in a little while."));
	}
}
?>