...
<br/>
<form action="searching.html" method="get" target="new">
<span class="account">
...
<!-- where each item generates its own div and elements -->

<div class="items">
<h3><?=htmlspecialchars($auction['ITEM_CAPTION'])?></h3>
<img src="auctionPhoto.php?id=<?=htmlspecialchars($auction['AUCTION_ID'])?>" />
<br/>
<dl>
<dt>Category:</dt>
