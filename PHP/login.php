...
<form name="user" action="signed.php" method="get">
<span class="search">
Username:
...
<div class="red">
<h1>Login</h1>
<form class="login" name="user" action="signed.php" method="get">
Username:
...
<div class="red">
<h1>Sign-up</h1>
<form class="register" name="register" action="signed.php" method="get">
First Name:
